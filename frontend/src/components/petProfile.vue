<template>
    ...
    <!-- {{ pet.name }} -->
      ...
      <div class="p-2" v-if="pet.animalType == 'ant'">
        <Icon icon="noto-v1:ant" class="text-black=100 h-10 w-auto" />
        <div>{{ pet.name }} </div>
      </div>
       <div class="p-2" v-if="pet.animalType == 'bird'">
        <Icon icon="noto-v1:bird" class="text-black=100 h-10 w-auto" />
        <div>{{ pet.name }} </div>
      </div>
      <div class="p-2" v-if="pet.animalType == 'cat'">
        <Icon icon="noto-v1:cat-face" class="text-black=100 h-10 w-auto" />
        <div>{{ pet.name }} </div>
      </div>
  <div class="p-2" v-if="pet.animalType == 'crocodile'">
        <Icon icon="noto-v1:crocodile" class="text-black=100 h-10 w-auto" />
        <div>{{ pet.name }} </div>
      </div>
      <div class="p-2" v-if="pet.animalType == 'dog'">
        <Icon icon="noto-v1:dog-face" class="text-black=100 h-10 w-auto" />
        <div>{{ pet.name }} </div>
      </div>
  
      <div class="p-2" v-if="pet.animalType == 'fish'">
        <Icon icon="noto-v1:tropical-fish" class="text-black=100 h-10 w-auto" />
        <div>{{ pet.name }} </div>
      </div>
      <div class="p-2" v-if="pet.animalType == 'frog'">
        <Icon icon="noto:frog" class="text-black=100 h-10 w-auto" />
        <div>{{ pet.name }} </div>
      </div>
      <div class="p-2" v-if="pet.animalType == 'lion'">
        <Icon icon="noto-v1:lion" class="text-black=100 h-10 w-auto" />
        <div>{{ pet.name }} </div>
      </div>
      <div class="p-2" v-if="pet.animalType == 'monkey'">
        <Icon icon="noto-v1:monkey-face" class="text-black=100 h-10 w-auto" />
        <div>{{ pet.name }} </div>
      </div>
      <div class="p-2" v-if="pet.animalType == 'pig'">
        <Icon icon="noto:pig-face" class="text-black=100 h-10 w-auto" />
        <div>{{ pet.name }} </div>
      </div>
      <div class="p-2" v-if="pet.animalType == 'rabbit'">
        <Icon icon="noto-v1:rabbit-face" class="text-black=100 h-10 w-auto" />
        <div>{{ pet.name }} </div>
      </div>
      <div class="p-2" v-if="pet.animalType == 'turtle'">
