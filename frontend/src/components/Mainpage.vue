<template>
  <div class="min-h-screen bg-[#FFF3EB] flex flex-col overflow-hidden">
    ...
    <div class="flex-grow flex mt-20 overflow-hidden">
      ...
      <div class="w-1/4 py-4 pr-4 flex flex-col fixed h-full overflow-y-auto z-20">
        <LostPets class="w-5/6 mb-4 ml-8" />
        <Tag />
      </div>

      <!-- Scrollable Main Content -->
      <div class="grid grid-cols-8 justify-center flex-grow mt-4 ml-1/4 pr-4 overflow-y-auto h-full z-10">
