			...
			<div class="w-1/2 py-4 pr-4 flex-grow flex flex-col items-center">
				<div class="w-11/12 h-auto bg-white p-4 rounded-md">
					<div class="flex justify-between items-center mb-4">
						...
						<a href="/mainpage" class="text-base text-blue-500"
							>Back</a
						>
					</div>
					...
					<div class="flex flex-wrap -mx-2">
						...
						>
							<div
								class="w-full max-w-sm bg-white border border-black rounded-lg"
							>
								...
								<div class="flex flex-col items-center pb-10">
									...
									/>
									<h5
										class="mb-1 text-xl font-medium text-black dark:text-black"
									>
										{{ pet.name }}
									</h5>
									<span
										class="text-sm text-gray-500 dark:text-gray-400"
										>missing on {{ pet.date }}</span
									>
			...
			pets: [
				{
					name: 'Lola',
					date: '21/07/23',
					img: '../assets/pets/petpic1.png',
				},
				{
					name: 'Lucy',
					date: '02/12/18',
					img: '../assets/pets/petpic2.png',
				},
				{
					name: 'Sweed',
					date: '29/09/23',
					img: '../assets/pets/petpic3.png',
				},
				{
					name: 'Khun Somsri',
					date: '11/01/24',
					img: '../assets/pets/petpic4.png',
				},
				{
					name: 'A',
					date: '21/07/23',
