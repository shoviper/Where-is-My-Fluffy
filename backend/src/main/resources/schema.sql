...
INSERT INTO pets (name, age, description, status, owner_id, animal_type) VALUES ('Fido', 3, 'A cute dog', 'MISSING', 1, 'dog');
INSERT INTO pets (name, age, description, status, owner_id, animal_type) VALUES ('Kitty', 1, 'A cute cat', 'FOUND', 2, 'cat');
