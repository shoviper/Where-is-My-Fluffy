...
INSERT INTO pets (name, age, description, status, location_id, owner_id, animal_type, founder_id, reward_amount) VALUES ('Kitty', 1, 'A cute cat', 'FOUND', 2, 1, 'cat', 2, 10.0);
INSERT INTO pets (name, age, description, status, location_id, owner_id, animal_type, founder_id, reward_amount) VALUES ('Fido', 3, 'A cute dog', 'MISSING', 1, 2, 'dog', NULL, 30.0);
